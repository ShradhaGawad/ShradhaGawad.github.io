...
•	Assisted clients with Data Validation for ensuring data integrity, completeness, and correctness before utilizing it for end-to-end testing. 
•	Reduced client turnover time by 50% through on-call support, showcasing a commitment to prompt service.
•	Demonstrated technical expertise in SQL, APIs, GitHub, Jenkins by mentoring teammates, contributing to better decision making while troubleshooting customer issues.                      
LTIMindtree (HBO, LOREAL)						             		           November 2016-March 2021
QA Analyst                  
•	Led collaborative efforts with clients, to deliver requirements through manual and automation testing.
•	Streamlined testing processes by creating and maintaining 3000+ test cases in TOSCA, reducing manual testing by 20% in bi-weekly sprints and 60% during UAT Weekly releases.
•	Conducted thorough validation of Data across Microservices to guarantee accurate data delivery across diverse platforms.
...
•	International Software Testing Qualifications Board - Foundation Level - By ISTQB.
